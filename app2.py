...
marketing_df=pd.read_csv('C:/Users/SarahAbouIbrahim/Desktop/marketing_data.csv')
...
img = load_image('C:/Users/SarahAbouIbrahim/Desktop/audience-analytics-header.jpg')
st.image(img)
